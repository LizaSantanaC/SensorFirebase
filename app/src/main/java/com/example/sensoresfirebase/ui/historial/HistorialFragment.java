package com.example.sensoresfirebase.ui.historial;
...
import com.example.sensoresfirebase.sensores.MySensor;
import com.example.sensoresfirebase.ui.sensores.SensoresFragment;
...
public class HistorialFragment extends Fragment implements ValueEventListener {
    ...
    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        for (DataSnapshot registro: dataSnapshot.getChildren()){ //Se mandan los regisstros d ela base de datos y se recorre cada elemento o sea el sensor
